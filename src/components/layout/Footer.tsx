 ...
 * Visible on mobile/tablet, hidden on desktop (which has sidebar)
 */
export default function Footer() {
    ...
    return (
        <footer className="lg:hidden border-t border-border bg-background pb-20">
            <div className="max-w-[1200px] mx-auto px-6 py-8">
                {/* Contact heading */}
                <h3 className="text-sm font-bold uppercase tracking-widest text-foreground mb-6 text-center">
                    Get in Touch
                </h3>
                    ...
                    {socialLinks.map((link) => (
                        <div key={link.name} className="relative group">
                            <a
                                ...
                                className="text-muted-foreground hover:text-accent transition-colors duration-200 flex flex-col items-center gap-2"
                ...
                <p className="text-center text-xs text-muted-foreground">
                    © {currentYear} Ilya Goykhfis. All rights reserved.
                </p>
            </div>
        </footer>
    );
